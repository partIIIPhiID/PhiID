# -*- coding: utf-8 -*-
"""
Created on Mon May  2 18:33:44 2022
...
for i in range(0,3):
    ...
    x = np.transpose(data_forLDA['rtr'])
    ...
    #predicting_x = np.transpose(np.transpose([x[j] for j in predicting_trials])) #think of it like shaking your TV to get it to work
