...
matlab -nodesktop -nosplash -r "mass_performance_test_squared(${SLURM_ARRAY_TASK_ID}, [68, 69, 70, 71, 72, 73, 74, 75, 76], 'AuMa_26_filtd_avgd_epochd_importID_epdeleted_ICA_pruned_interp_avgd.set', '/rds/project/tb419/rds-tb419-bekinschtein/Yanzhi/EXP_1_Masking/', '/rds/project/tb419/rds-tb419-bekinschtein/Yanzhi/EXP_1_Masking/', 'Original_epochs_pilot_26'); quit"
